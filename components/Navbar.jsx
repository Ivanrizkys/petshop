...
const Navbar = ({screenWidth}) => {
    ...
    return (
        <Container>
            ...
            <ul className={`flex flex-col justify-around md:justify-evenly items-center absolute w-screen h-screen right-0 top-0 bg-orange-transparant z-10 transition duration-500 transform ${!toggle && "translate-x-full"}`}>
                {screenWidth <= 768 &&
                    <>
